# Changes to Base Game: Different Music, Different Player and Missile Sprites, Added Title Bar Name (Missile Dodge by Jack Shorenstein)
...
pygame.mixer.init()
pygame.mixer.music.load("Missile Dodge/bombsoverbrooklyn.mp3")
