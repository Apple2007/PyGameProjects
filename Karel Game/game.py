...
pygame.mixer.music.load("Karel Game/Digital Days.mp3")
...
class player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("Karel Game/karel.png")
...
class tennis_ball(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("Karel Game/tennis_ball.png")
        self.rect = self.image.get_rect()
